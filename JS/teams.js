...
var $teams = $.get("http://localhost:1337/http://nflarrest.com/api/v1/team", function(team) {
...
$teams.done(function(teamList){
  ...
  $.each(teamList, function(t,teamList) {
    $.get("http://localhost:1337/http://nflarrest.com/api/v1/team/arrests/" + teamList.Team, function(player) {
